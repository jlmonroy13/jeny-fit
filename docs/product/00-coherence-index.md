...
> **Estado:** v0.5 — docs 01–11 cerrados; **M2** detallada en doc 12 §6. Siguiente: sync → code.
...
| **12**                   | Plan                       | RM-*, Mx-NN | v0.5 — M2 detallada (§6); M3+ esqueleto |
...
| ID  | Doc | Tema                                                          |
| --- | --- | ------------------------------------------------------------- |
| —   | —   | _(ninguna OPEN de producto/stack; M2 en sync/implementación)_ |
